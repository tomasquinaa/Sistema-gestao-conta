        ...
        <tbody>
            @forelse($contas as $conta)
                <tr>
                    ...
                    <td style="border: 1px solid #ccc; border-top: none;">{{ 'Kz '  . number_format($conta->valor, 2, ',', '.')}}</td>
            ...
            <tr>
                ...
                <td style="border: 1px solid #ccc; border-top: none;">{{ 'Kz ' . number_format($totalValor, 2, ',', '.')}}</td>
            </tr>
        </tbody>
    </table>
</body>
